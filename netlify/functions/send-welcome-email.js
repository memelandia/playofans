...
// Función interna reutilizable (llamada desde sa-create-model y sa-review-registration)
async function sendWelcomeEmail({ email, display_name, slug, password, admin_url }) {
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const result = await sendWelcomeEmail({ email, display_name, slug, password, admin_url });
...
// Exportar para uso interno desde sa-create-model.js y sa-review-registration.js
